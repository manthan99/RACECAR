...
//  rpy_data.angular.z = accel_t_gyro.value.z_gyro - base_z_gyro;
//  rpy_data.angular.y = accel_t_gyro.value.y_gyro - base_y_gyro;
//  rpy_data.angular.x = accel_t_gyro.value.x_gyro - base_x_gyro;
float RADIANS_TO_DEGREES = 180/3.14159;
  rpy_data.angular.z = gyro_z/RADIANS_TO_DEGREES;
  rpy_data.angular.y = gyro_y/RADIANS_TO_DEGREES;
  rpy_data.angular.x = gyro_x/RADIANS_TO_DEGREES;
...
//  Serial.println(F(""));
   ...
   rpy_data.linear.z = angle_z;
   rpy_data.linear.y = angle_y;
   rpy_data.linear.x = angle_x;
